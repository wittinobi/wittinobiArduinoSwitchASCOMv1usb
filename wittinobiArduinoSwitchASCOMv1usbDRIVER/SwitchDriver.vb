...
'
' ASCOM Switch driver for wittinobiArduinoSwitchASCOMv1usbDRIVER
'
...
'
'
' Your driver's ID is ASCOM.wittinobiArduinoSwitchASCOMv1usbDRIVER.Switch
'
...
Public Class Switch
    ...
    Private Shared driverDescription As String = "wittinobiArduinoSwitchASCOMv1usbDRIVER Switch"
    ...
    Public Sub New()
        ...
        TL = New TraceLogger("", "wittinobiArduinoSwitchASCOMv1usbDRIVER")
...
#Region "Common properties and methods"
    ...
    Public ReadOnly Property Name As String Implements ISwitchV2.Name
        Get
            Dim s_name As String = "wittinobiArduinoSwitchASCOMv1usbDRIVER"
